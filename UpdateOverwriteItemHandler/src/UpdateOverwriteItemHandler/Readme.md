...
```
    cd "UpdateOverwriteItemHandler"
    dotnet restore
```

Execute unit tests
```
    cd "UpdateOverwriteItemHandler/test/UpdateOverwriteItemHandler.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "UpdateOverwriteItemHandler/src/UpdateOverwriteItemHandler"
